...
class ProfileViewController: UIViewController, UINavigationControllerDelegate {
    ...
    @IBAction func editPicAction(_: Any) {
    ...
    @objc func inputModeDidChange(sender _: NSNotification) {
        if isEmojiKeyboard() {
            print("is emoji")
    ...
    @IBAction func editButtonPressed(_: Any) {
...
extension ProfileViewController: UITextViewDelegate {
    ...
    @objc func textViewDidChange(_: UITextView) {
        handleSaveButtonStyle(canSave: dataWasChanged)
    }
}
