...
class ProfileViewController: UIViewController, UINavigationControllerDelegate, UIImagePickerControllerDelegate {
    ...
    private var dataWasChanged: Bool {
        get {
            return self.profile?.nameChanged ?? false ||
                self.profile?.infoChanged ?? false ||
                self.profile?.imageChanged ?? false
        }
    }
    ...
    private func layerStyleInstall() {
        ...
        self.addPictureButton.imageEdgeInsets = UIEdgeInsets(top: spacing,
                                                             left: spacing,
                                                             bottom: spacing,
                                                             right: spacing)
